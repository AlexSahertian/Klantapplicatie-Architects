...
namespace DataAccessLayer
{
    public static class MatrixIncDbInitializer
    {
        public static void Initialize(MatrixIncDbContext context)
        {
            ...
            {
                new Order { Customer = customers[0], OrderDate = DateTime.Parse("2021-01-01"), Status = OrderStatus.PROCESSING },
                new Order { Customer = customers[0], OrderDate = DateTime.Parse("2021-02-01"), Status = OrderStatus.DELIVERING },
                new Order { Customer = customers[1], OrderDate = DateTime.Parse("2021-02-01"), Status = OrderStatus.DELIVERED },
                new Order { Customer = customers[2], OrderDate = DateTime.Parse("2021-03-01"), Status = OrderStatus.DEPOT }
            };
